...
Lesen Sie die Aufgabenstellung vollständig, bevor Sie mit dem Programmieren anfangen. Diese Beschreibung bezieht sich auf zwei Spieler.
...
offen aufgedeckt.
4. Dann können die Spieler abwechselnd Spielsteine links oder rechts anlegen. In jeder Spielrunde (vgl. Punkt 12) beginnt immer der erste Spieler.
Dabei dürfen im Beispiel an [0|4] auf der linken Seite nur Steine angelegt werden, die rechts eine 0 stehen haben, z.B. [3|0]. Analoges gilt für
die rechte Seite. Ein Drehen der Steine, also aus [3|0] eine [0|3] machen,
ist nicht erlaubt.

==================Aufgabenstellung Domino Spielregeln 2/5=========================

5. Falls ein Spieler keinen Stein anlegen kann, muss er, solange noch restliche Spielsteine zur Verfügung stehen, einen Stein ziehen und zu seinen hinzufügen. Es besteht keine Pflicht anzulegen. Wenn noch Steine
...
13. Nutzen Sie die Klasse DominoPool von Folie 12, die Ihnen einen gemischten Satz von Dominosteinen zur Verfügung stellt. D.h. jedoch
...
hazardierenden Spieler oder gar gegen einen anderen menschlichen Spieler anzutreten ist an dieser Stelle nicht erwünscht.
16. Bitte beachten Sie die Reihenfolge des Verteilens an die Spieler in Punkt
3!
